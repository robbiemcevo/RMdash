    ...
    const success = await firebase.functions().httpsCallable('updateClientKYC')(
      {
        ...
        sector: data.sector,
        languages_of_reporting: data.languages_of_reporting,
        domicile: data.domicile,
        is_using_internet_banking: data.is_using_internet_banking,
        government_document_attached: data.government_document_attached,
        reporting_currency: data.reporting_currency,
        mailing_address: data.mailing_address,
        paper_mailing: data.paper_mailing,
        transit_account_number: data.transit_account_number,
        transit_account_holder: data.transit_account_holder,
