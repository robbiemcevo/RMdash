      ...
      <Container>
        ...
        <Content padder>
          <Card transparent style={{borderRadius: 5}}>
            ...
            <CardItem>
              <Text style={{fontSize: 18, marginStart: 0}}>
                Choose a new password - at least 8 characters which contain at
            ...
            <Button
              ...
              <Text style={{fontSize: 19, marginStart:17}}> Save</Text>
            </Button>
            <CardItem
              header
              bordered
            ...
            <CardItem>
              <Text style={{fontSize: 18, marginStart: 0}}>
                If you want to log out, do it by pressing the button below
              </Text>
            </CardItem>
