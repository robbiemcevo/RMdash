            ...
            <ListItem thumbnail style={{marginTop: 20, marginBottom: 20}}>
              ...
              <Right>
                <Button
                  ...
                  style={{color: '103662'}}
                  onPress={() =>
                    this.props.navigation.navigate('ClientsNavigator', {
            ...
            <ListItem thumbnail style={{marginTop: 20, marginBottom: 20}}>
              ...
              <Right>
                <Button
                  bordered
                  style={{color: '103662'}}
                  onPress={() => this.props.navigation.navigate('ClientOverV')}>
                  <Text style={{color: '#103662'}}>View</Text>
                </Button>
              </Right>
            </ListItem>
            ...
            <ListItem thumbnail style={{marginTop: 10, marginBottom: 20}}>
              <Left>
                <Thumbnail
                  ...
                  source={{
                    uri:
                      'https://lh3.googleusercontent.com/proxy/nLzSlghoUSDucmhDZbZIN26X5GirVVvmscIm4hHql9j5vqTQmKWfZbayg0Mb8maWKD3NWnkcGUDmUa2xr6mlgZn1_0jKwGMbFeW1Xf5OfOCRmwzQ4GX2p0gpmhVAr4AircRiUQ',
                  }}
                />
              </Left>
              <Body>
